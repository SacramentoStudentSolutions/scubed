...
$conect = mysqli_connect("athena","cscadvisingform","egbagitj", "cscadvisingform") or die(mysql_error()); 
...
if(isset($_COOKIE['ID_your_site'])){ //if there is, it logs you in and directes you to the members page
 	...
 	$check = mysqli_query($conect, "SELECT * FROM Login WHERE username = '$username'")or die(mysql_error());
 ...
 if (isset($_POST['submit'])) {
	// makes sure they filled it in
 	...
 	$check = mysqli_query($conect, "SELECT * FROM Login WHERE username = '".$_POST['username']."'")or die(mysql_error());
